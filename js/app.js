...
// // движущаяся точка
// let header__move = document.querySelector('.header__move');
// let btn = document.querySelector('.btn');
// window.addEventListener('scroll', scroll_scroll);
// function scroll_scroll() {
// 	console.log(window.pageYOffset);
// 	if(window.pageYOffset < 1){
// 		header__move.style.width = '0%';
// 		header__move.style.height = '0%';
// 		header__move.style.top = "70px";
// 		header__move.style.left = "150px";
// 	}
// 	if((window.pageYOffset >= 1) && (window.pageYOffset < 70)){
// 		header__move.style.width = '35px';
// 		header__move.style.height = '35px';
// 		header__move.style.top = ((70 + window.pageYOffset)*1.3)+"px";
// 		header__move.style.left = ((170 + window.pageYOffset))+"px";
// 	}
// 	if((window.pageYOffset >= 70) && (window.pageYOffset < 270)){
// 		header__move.style.width = '35px';
// 		header__move.style.height = '35px';
// 		btn.style.border = '2px solid #d4c3c6';
// 		btn.style.animation = 'none';
// 		header__move.style.top = ((70 + window.pageYOffset)*2-70)+"px";
// 		header__move.style.left = ((170 + window.pageYOffset)*2.2-300)+"px";
// 		header__move.style.display = 'inline-block';
		
// 	}
// 	if((window.pageYOffset >= 270) && (window.pageYOffset < 400)){
// 		btn.style.border = '2px solid #FF1640';
// 		btn.style.animation = 'heartbeat1 1.5s ease-in-out both';
// 		header__move.style.width = '0%';
// 		header__move.style.height = '0%';
// 		header__move.style.display = 'none';
// 		header__move.style.top = (300 + window.pageYOffset)+"px";
// 		header__move.style.left = "230px";
// 	}
...
let currentScrollY = false;
//ScrollOnScroll
if(window.pageYOffset >= 1){
	let header1 = document.querySelector('.header');
	header1.classList.add('_act');
}
...
function scroll_scroll() {
	...
	if(window.innerWidth > 750){
		if(window.pageYOffset < 1){		
			if(header1.classList.contains('_act')){
				header1.classList.remove('_act');
			}
		}
		else if((window.pageYOffset >= 1) && (window.pageYOffset < 26)){
			if(!header1.classList.contains('_act')){
				header1.classList.add('_act');
			}
			header1.style.paddingTop = (51 - window.pageYOffset) + "px";
		}
		else if((window.pageYOffset >= 26) && (window.pageYOffset < 150)){
			if(!header1.classList.contains('_act')){
				header1.classList.add('_act');
			}
		}
	...
	if (scr_items.length > 0) {
		for (let index = 0; index < scr_items.length; index++) {
			...
			let scr_item_point = window.innerHeight - (window.innerHeight/6*5 - scr_item_height / 3);
			if (window.innerHeight > scr_item_height) {
				scr_item_point = window.innerHeight/6*5 - scr_item_height / 3;
			}
